...
export default function LoginPage() {
    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            ...
            const res = await fetch("http://localhost:8085/login-google", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                ...
                <form onSubmit={handleSubmit} className="w-full max-w-md">
                    <Card>
                        <CardHeader className="space-y-2 text-center">
                            ...
                            <CardDescription>Accede a tu cuenta para continuar entrenando</CardDescription>
                        </CardHeader>
                        ...
                        <CardFooter className="flex flex-col space-y-4">
                            ...
                            <Button variant="outline" onClick={handleGoogleLogin} className="w-full flex items-center justify-center gap-2 h-10" disabled={isLoading}>
